...
function displayItems() {
    ...
    if (countCheeseburger > 0) {
        document.getElementById("displayed_items").innerHTML += countCheeseburger + " X " + item[i].product_Name + " " + item[i].product_Price + " KR." + "<br>"

    }

    if (countWater > 0) {
        document.getElementById("displayed_items").innerHTML += countWater + " X " + item[i].product_Name + " " + item[i].product_Price + " KR. " + "<br>";
    }

    if (countRice > 0){
        document.getElementById("displayed_items").innerHTML += countRice + " X " + item[i].product_Name + " " + item[i].product_Price + " KR. " + "<br>";
    }
